...
export const services: Service[] = [
  {
    ...
    description:
      "Creamos narrativas originales que vinculan emociones con tu marca.",
    fullDescription:
    ...
    image: "/images/onsight_branded.webp",
    icon: FaFilm,
    featured: false,
  },
  {
    ...
    description:
      "Producimos y retransmitimos tus eventos en tiempo real con la más alta calidad técnica.",
    fullDescription:
    ...
    image: "/images/onsight_streaming.webp",
  ...
  },
  {
    ...
    description:
      "Reflejamos los valores y la identidad de tu empresa con producciones audiovisuales de máxima calidad.",
    fullDescription:
    ...
    image: "/images/onsight_corporativos.webp",
    icon: FaBuilding,
    featured: false,
  },
  {
    ...
    description:
      "Producimos los vídeos que necesita cada etapa de tu funnel: desde el anuncio que capta la atención hasta el VSL que cierra la venta.",
    fullDescription:
    ...
    image: "/images/onsight_making-of.webp",
    icon: FaPlay,
    featured: false,
  },
  {
    ...
    description:
      "Diseñamos y desarrollamos webs, landings de venta y embudos de conversión que transforman visitas en clientes.",
    fullDescription:
  ...
  },
  {
    ...
    description:
      "El estudio profesional y el equipo que necesitas para elevar tu contenido al siguiente nivel.",
    fullDescription:
